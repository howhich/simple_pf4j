...
public class Plugins {
    public static JarPluginManager pluginManager = new JarPluginManager();

    public static void startPlugin(String plugin){
        // 插件ID
//        String plugin = "rule-plugin";
    ...
    public static void stopPlugins(String plugin){
        // 停用插件
